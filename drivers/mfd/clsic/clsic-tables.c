...
bool clsic_readable_register(struct device *dev, unsigned int reg)
{
	...
	case TACNA_ASP2TX5MIX_INPUT1:
	case TACNA_ASP2TX5MIX_INPUT2:
	case TACNA_ASP2TX5MIX_INPUT3:
	case TACNA_ASP2TX5MIX_INPUT4:
	case TACNA_ASP2TX6MIX_INPUT1:
	case TACNA_ASP2TX6MIX_INPUT2:
	case TACNA_ASP2TX6MIX_INPUT3:
	case TACNA_ASP2TX6MIX_INPUT4:
	case TACNA_ASP2TX7MIX_INPUT1:
	case TACNA_ASP2TX7MIX_INPUT2:
	case TACNA_ASP2TX7MIX_INPUT3:
	case TACNA_ASP2TX7MIX_INPUT4:
	case TACNA_ASP2TX8MIX_INPUT1:
	case TACNA_ASP2TX8MIX_INPUT2:
	case TACNA_ASP2TX8MIX_INPUT3:
	case TACNA_ASP2TX8MIX_INPUT4:
	...
	case TACNA_ASP3TX5MIX_INPUT1:
	case TACNA_ASP3TX5MIX_INPUT2:
	case TACNA_ASP3TX5MIX_INPUT3:
	case TACNA_ASP3TX5MIX_INPUT4:
	case TACNA_ASP3TX6MIX_INPUT1:
	case TACNA_ASP3TX6MIX_INPUT2:
	case TACNA_ASP3TX6MIX_INPUT3:
	case TACNA_ASP3TX6MIX_INPUT4:
	case TACNA_ASP3TX7MIX_INPUT1:
	case TACNA_ASP3TX7MIX_INPUT2:
	case TACNA_ASP3TX7MIX_INPUT3:
	case TACNA_ASP3TX7MIX_INPUT4:
	case TACNA_ASP3TX8MIX_INPUT1:
	case TACNA_ASP3TX8MIX_INPUT2:
	case TACNA_ASP3TX8MIX_INPUT3:
	case TACNA_ASP3TX8MIX_INPUT4:
	...
	case TACNA_ASP4TX5MIX_INPUT1:
	case TACNA_ASP4TX5MIX_INPUT2:
	case TACNA_ASP4TX5MIX_INPUT3:
	case TACNA_ASP4TX5MIX_INPUT4:
	case TACNA_ASP4TX6MIX_INPUT1:
	case TACNA_ASP4TX6MIX_INPUT2:
	case TACNA_ASP4TX6MIX_INPUT3:
	case TACNA_ASP4TX6MIX_INPUT4:
	case TACNA_ASP4TX7MIX_INPUT1:
	case TACNA_ASP4TX7MIX_INPUT2:
	case TACNA_ASP4TX7MIX_INPUT3:
	case TACNA_ASP4TX7MIX_INPUT4:
	case TACNA_ASP4TX8MIX_INPUT1:
	case TACNA_ASP4TX8MIX_INPUT2:
	case TACNA_ASP4TX8MIX_INPUT3:
	case TACNA_ASP4TX8MIX_INPUT4:
	...
	case CLSIC_ASRC2_IN1L_INPUT1:
	case CLSIC_ASRC2_IN1R_INPUT1:
	case CLSIC_ASRC2_IN2L_INPUT1:
	case CLSIC_ASRC2_IN2R_INPUT1:
	...
	case TACNA_DSP1RX9MIX_INPUT1:
	case TACNA_DSP1RX9MIX_INPUT2:
	case TACNA_DSP1RX9MIX_INPUT3:
	case TACNA_DSP1RX9MIX_INPUT4:
	...
	case TACNA_SWIRE1_DP1TX7MIX_INPUT1:
	case TACNA_SWIRE1_DP1TX7MIX_INPUT2:
	case TACNA_SWIRE1_DP1TX7MIX_INPUT3:
	case TACNA_SWIRE1_DP1TX7MIX_INPUT4:
	case TACNA_SWIRE1_DP1TX8MIX_INPUT1:
	case TACNA_SWIRE1_DP1TX8MIX_INPUT2:
	case TACNA_SWIRE1_DP1TX8MIX_INPUT3:
	case TACNA_SWIRE1_DP1TX8MIX_INPUT4:
	...
	case TACNA_SWIRE1_DP2TX7MIX_INPUT1:
	case TACNA_SWIRE1_DP2TX7MIX_INPUT2:
	case TACNA_SWIRE1_DP2TX7MIX_INPUT3:
	case TACNA_SWIRE1_DP2TX7MIX_INPUT4:
	case TACNA_SWIRE1_DP2TX8MIX_INPUT1:
	case TACNA_SWIRE1_DP2TX8MIX_INPUT2:
	case TACNA_SWIRE1_DP2TX8MIX_INPUT3:
	case TACNA_SWIRE1_DP2TX8MIX_INPUT4:
...
const struct reg_default clsic_reg_defaults[] = {
	...
	{ 0x00008340, 0x00800000 }, /* ASP2TX5MIX_INPUT1 */
	{ 0x00008344, 0x00800000 }, /* ASP2TX5MIX_INPUT2 */
	{ 0x00008348, 0x00800000 }, /* ASP2TX5MIX_INPUT3 */
	{ 0x0000834c, 0x00800000 }, /* ASP2TX5MIX_INPUT4 */
	{ 0x00008350, 0x00800000 }, /* ASP2TX6MIX_INPUT1 */
	{ 0x00008354, 0x00800000 }, /* ASP2TX6MIX_INPUT2 */
	{ 0x00008358, 0x00800000 }, /* ASP2TX6MIX_INPUT3 */
	{ 0x0000835c, 0x00800000 }, /* ASP2TX6MIX_INPUT4 */
	{ 0x00008360, 0x00800000 }, /* ASP2TX7MIX_INPUT1 */
	{ 0x00008364, 0x00800000 }, /* ASP2TX7MIX_INPUT2 */
	{ 0x00008368, 0x00800000 }, /* ASP2TX7MIX_INPUT3 */
	{ 0x0000836c, 0x00800000 }, /* ASP2TX7MIX_INPUT4 */
	{ 0x00008370, 0x00800000 }, /* ASP2TX8MIX_INPUT1 */
	{ 0x00008374, 0x00800000 }, /* ASP2TX8MIX_INPUT2 */
	{ 0x00008378, 0x00800000 }, /* ASP2TX8MIX_INPUT3 */
	{ 0x0000837c, 0x00800000 }, /* ASP2TX8MIX_INPUT4 */
	...
	{ 0x00008440, 0x00800000 }, /* ASP3TX5MIX_INPUT1 */
	{ 0x00008444, 0x00800000 }, /* ASP3TX5MIX_INPUT2 */
	{ 0x00008448, 0x00800000 }, /* ASP3TX5MIX_INPUT3 */
	{ 0x0000844c, 0x00800000 }, /* ASP3TX5MIX_INPUT4 */
	{ 0x00008450, 0x00800000 }, /* ASP3TX6MIX_INPUT1 */
	{ 0x00008454, 0x00800000 }, /* ASP3TX6MIX_INPUT2 */
	{ 0x00008458, 0x00800000 }, /* ASP3TX6MIX_INPUT3 */
	{ 0x0000845c, 0x00800000 }, /* ASP3TX6MIX_INPUT4 */
	{ 0x00008460, 0x00800000 }, /* ASP3TX7MIX_INPUT1 */
	{ 0x00008464, 0x00800000 }, /* ASP3TX7MIX_INPUT2 */
	{ 0x00008468, 0x00800000 }, /* ASP3TX7MIX_INPUT3 */
	{ 0x0000846c, 0x00800000 }, /* ASP3TX7MIX_INPUT4 */
	{ 0x00008470, 0x00800000 }, /* ASP3TX8MIX_INPUT1 */
	{ 0x00008474, 0x00800000 }, /* ASP3TX8MIX_INPUT2 */
	{ 0x00008478, 0x00800000 }, /* ASP3TX8MIX_INPUT3 */
	{ 0x0000847c, 0x00800000 }, /* ASP3TX8MIX_INPUT4 */
	...
	{ 0x00008540, 0x00800000 }, /* ASP4TX5MIX_INPUT1 */
	{ 0x00008544, 0x00800000 }, /* ASP4TX5MIX_INPUT2 */
	{ 0x00008548, 0x00800000 }, /* ASP4TX5MIX_INPUT3 */
	{ 0x0000854c, 0x00800000 }, /* ASP4TX5MIX_INPUT4 */
	{ 0x00008550, 0x00800000 }, /* ASP4TX6MIX_INPUT1 */
	{ 0x00008554, 0x00800000 }, /* ASP4TX6MIX_INPUT2 */
	{ 0x00008558, 0x00800000 }, /* ASP4TX6MIX_INPUT3 */
	{ 0x0000855c, 0x00800000 }, /* ASP4TX6MIX_INPUT4 */
	{ 0x00008560, 0x00800000 }, /* ASP4TX7MIX_INPUT1 */
	{ 0x00008564, 0x00800000 }, /* ASP4TX7MIX_INPUT2 */
	{ 0x00008568, 0x00800000 }, /* ASP4TX7MIX_INPUT3 */
	{ 0x0000856c, 0x00800000 }, /* ASP4TX7MIX_INPUT4 */
	{ 0x00008570, 0x00800000 }, /* ASP4TX8MIX_INPUT1 */
	{ 0x00008574, 0x00800000 }, /* ASP4TX8MIX_INPUT2 */
	{ 0x00008578, 0x00800000 }, /* ASP4TX8MIX_INPUT3 */
	{ 0x0000857c, 0x00800000 }, /* ASP4TX8MIX_INPUT4 */
	...
	{ 0x00009080, 0x00800000 }, /* DSP1RX9MIX_INPUT1 */
	{ 0x00009084, 0x00800000 }, /* DSP1RX9MIX_INPUT2 */
	{ 0x00009088, 0x00800000 }, /* DSP1RX9MIX_INPUT3 */
	{ 0x0000908c, 0x00800000 }, /* DSP1RX9MIX_INPUT4 */
	...
	{ 0x00009860, 0x00800000 }, /* SWIRE1_DP1TX7MIX_INPUT1 */
	{ 0x00009864, 0x00800000 }, /* SWIRE1_DP1TX7MIX_INPUT2 */
	{ 0x00009868, 0x00800000 }, /* SWIRE1_DP1TX7MIX_INPUT3 */
	{ 0x0000986c, 0x00800000 }, /* SWIRE1_DP1TX7MIX_INPUT4 */
	{ 0x00009870, 0x00800000 }, /* SWIRE1_DP1TX8MIX_INPUT1 */
	{ 0x00009874, 0x00800000 }, /* SWIRE1_DP1TX8MIX_INPUT2 */
	{ 0x00009878, 0x00800000 }, /* SWIRE1_DP1TX8MIX_INPUT3 */
	{ 0x0000987c, 0x00800000 }, /* SWIRE1_DP1TX8MIX_INPUT4 */
	...
	{ 0x000098e0, 0x00800000 }, /* SWIRE1_DP2TX7MIX_INPUT1 */
	{ 0x000098e4, 0x00800000 }, /* SWIRE1_DP2TX7MIX_INPUT2 */
	{ 0x000098e8, 0x00800000 }, /* SWIRE1_DP2TX7MIX_INPUT3 */
	{ 0x000098ec, 0x00800000 }, /* SWIRE1_DP2TX7MIX_INPUT4 */
	{ 0x000098f0, 0x00800000 }, /* SWIRE1_DP2TX8MIX_INPUT1 */
	{ 0x000098f4, 0x00800000 }, /* SWIRE1_DP2TX8MIX_INPUT2 */
	{ 0x000098f8, 0x00800000 }, /* SWIRE1_DP2TX8MIX_INPUT3 */
	{ 0x000098fc, 0x00800000 }, /* SWIRE1_DP2TX8MIX_INPUT4 */
