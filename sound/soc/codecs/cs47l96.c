...
static int cs47l96_component_probe(struct snd_soc_component *comp)
{
	...
	ret = tacna_init_outputs(comp, cs47l96_mono_routes,
	...
	wm_adsp2_component_probe(&cs47l96->core.dsp[0], comp);
...
static const struct snd_soc_component_driver soc_component_dev_cs47l96 = {
