...
extern int tacna_dsp_add_component_controls(struct snd_soc_component *comp,
					    unsigned int dsp_n);
...
extern int tacna_set_sysclk(struct snd_soc_component *comp, int clk_id,
...
static inline int tacna_register_notifier(struct snd_soc_component *comp,
...
static inline int tacna_unregister_notifier(struct snd_soc_component *comp,
					    struct notifier_block *nb)
{
	struct tacna *tacna = dev_get_drvdata(comp->dev->parent);
