...
TACNA_MIXER_CONTROLS("ASP2TX5", TACNA_ASP2TX5MIX_INPUT1),
TACNA_MIXER_CONTROLS("ASP2TX6", TACNA_ASP2TX6MIX_INPUT1),
TACNA_MIXER_CONTROLS("ASP2TX7", TACNA_ASP2TX7MIX_INPUT1),
TACNA_MIXER_CONTROLS("ASP2TX8", TACNA_ASP2TX8MIX_INPUT1),
...
TACNA_MIXER_CONTROLS("ASP3TX5", TACNA_ASP3TX5MIX_INPUT1),
TACNA_MIXER_CONTROLS("ASP3TX6", TACNA_ASP3TX6MIX_INPUT1),
TACNA_MIXER_CONTROLS("ASP3TX7", TACNA_ASP3TX7MIX_INPUT1),
TACNA_MIXER_CONTROLS("ASP3TX8", TACNA_ASP3TX8MIX_INPUT1),
...
TACNA_MIXER_CONTROLS("ASP4TX5", TACNA_ASP4TX5MIX_INPUT1),
TACNA_MIXER_CONTROLS("ASP4TX6", TACNA_ASP4TX6MIX_INPUT1),
TACNA_MIXER_CONTROLS("ASP4TX7", TACNA_ASP4TX7MIX_INPUT1),
TACNA_MIXER_CONTROLS("ASP4TX8", TACNA_ASP4TX8MIX_INPUT1),
...
TACNA_MIXER_CONTROLS("DSP1RX9", TACNA_DSP1RX9MIX_INPUT1),
...
TACNA_MIXER_ENUMS(ASP2TX5, TACNA_ASP2TX5MIX_INPUT1);
TACNA_MIXER_ENUMS(ASP2TX6, TACNA_ASP2TX6MIX_INPUT1);
TACNA_MIXER_ENUMS(ASP2TX7, TACNA_ASP2TX7MIX_INPUT1);
TACNA_MIXER_ENUMS(ASP2TX8, TACNA_ASP2TX8MIX_INPUT1);
...
TACNA_MIXER_ENUMS(ASP3TX5, TACNA_ASP3TX5MIX_INPUT1);
TACNA_MIXER_ENUMS(ASP3TX6, TACNA_ASP3TX6MIX_INPUT1);
TACNA_MIXER_ENUMS(ASP3TX7, TACNA_ASP3TX7MIX_INPUT1);
TACNA_MIXER_ENUMS(ASP3TX8, TACNA_ASP3TX8MIX_INPUT1);
...
TACNA_MIXER_ENUMS(ASP4TX5, TACNA_ASP4TX5MIX_INPUT1);
TACNA_MIXER_ENUMS(ASP4TX6, TACNA_ASP4TX6MIX_INPUT1);
TACNA_MIXER_ENUMS(ASP4TX7, TACNA_ASP4TX7MIX_INPUT1);
TACNA_MIXER_ENUMS(ASP4TX8, TACNA_ASP4TX8MIX_INPUT1);
...
TACNA_MUX_ENUMS(ASRC2IN1L, CLSIC_ASRC2_IN1L_INPUT1);
TACNA_MUX_ENUMS(ASRC2IN1R, CLSIC_ASRC2_IN1R_INPUT1);
TACNA_MUX_ENUMS(ASRC2IN2L, CLSIC_ASRC2_IN2L_INPUT1);
TACNA_MUX_ENUMS(ASRC2IN2R, CLSIC_ASRC2_IN2R_INPUT1);
...
TACNA_MIXER_ENUMS(DSP1RX9, TACNA_DSP1RX9MIX_INPUT1);
...
static const struct snd_soc_dapm_route clsic_dapm_routes[] = {
	...
	{ "ASP2TX5", NULL, "ASP2TXCLK" },
	{ "ASP2TX6", NULL, "ASP2TXCLK" },
	{ "ASP2TX7", NULL, "ASP2TXCLK" },
	{ "ASP2TX8", NULL, "ASP2TXCLK" },
	{ "ASP3TX1", NULL, "ASP3TXCLK" },
	{ "ASP3TX2", NULL, "ASP3TXCLK" },
	{ "ASP3TX3", NULL, "ASP3TXCLK" },
	{ "ASP3TX4", NULL, "ASP3TXCLK" },
	{ "ASP3TX5", NULL, "ASP3TXCLK" },
	{ "ASP3TX6", NULL, "ASP3TXCLK" },
	{ "ASP3TX7", NULL, "ASP3TXCLK" },
	{ "ASP3TX8", NULL, "ASP3TXCLK" },
	{ "ASP4TX1", NULL, "ASP4TXCLK" },
	{ "ASP4TX2", NULL, "ASP4TXCLK" },
	{ "ASP4TX3", NULL, "ASP4TXCLK" },
	{ "ASP4TX5", NULL, "ASP4TXCLK" },
	{ "ASP4TX6", NULL, "ASP4TXCLK" },
	{ "ASP4TX7", NULL, "ASP4TXCLK" },
	{ "ASP4TX8", NULL, "ASP4TXCLK" },
	...
	{ "ASRC2R1CLK", NULL, "SYSCLK" },
	{ "ASRC2R2CLK", NULL, "SYSCLK" },
	{ "ASRC2R1CLK", NULL, "ASYNCCLK" },
	{ "ASRC2R2CLK", NULL, "ASYNCCLK" },
